class Player:
    ...
    def write_result(self,tournament_stage,balls_win,balls_lost,game_win,game_lost,points):
        if tournament_stage ==  "group_stage":
            self.group_stage["balls_win"] +=balls_win
            self.group_stage["balls_lost"] +=balls_lost
            self.group_stage["games_win"] += game_win
            self.group_stage["games_lost"] += game_lost
            ...
            self.playoff_stage["games_win"] += game_win
            self.playoff_stage["games_lost"] += game_lost
