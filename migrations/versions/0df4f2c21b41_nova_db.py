...
def upgrade():
    ...
    sa.Column('total_players_in_playoff', sa.Integer(), nullable=True),
    ...
    op.create_table('consolation_stats',
    sa.Column('id', sa.Integer(), nullable=False),
...
def downgrade():
    ...
    op.drop_table('playoff_stats')
    op.drop_table('matches')
    op.drop_table('group_stats')
    op.drop_table('consolation_stats')
